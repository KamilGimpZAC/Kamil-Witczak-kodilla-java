...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://kamilgimpzac.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kamilgimp99@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("kamilwitczak1999");
    ...
    private void deleteTask(String taskName) throws InterruptedException {
        ...
        driver.findElements(
                By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[contains(@class,\"datatable__field-value\")]")).getText().equals(taskName))
                .forEach(theForm ->{
